...
const learningCards = [
  {
    id: 1,
    title: "Factors Affecting Prognosis",
    content: "• Most important survival predictor: clinical stage at diagnosis\n• Other influencing factors:\n  – Access to treatment\n  – Lymph node involvement\n  – Other health conditions (chronic/acute)\n  – Overall health, anemia\n  – Weakened immune system (e.g., HIV status)",
    infographic: "/placeholder.svg?height=300&width=400&text=Prognosis+Factors"
  }
];
...
export default function Section5_3({ onComplete, isUnlocked }: Section1_2Props) {
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <CardTitle className="text-xl">Section 3: Factors Influencing Prognosis</CardTitle>
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  Discover key factors that affect a woman&apos;s survival after cervical cancer diagnosis
                </p>
              </div>
            </div>
