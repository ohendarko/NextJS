...
const learningCards = [
  {
    ...
    content:
      "Cervical pre-cancer occurs when cells in the transformation zone of the cervix begin to grow abnormally. These early changes are not yet cancer, but they are not normal either.\n\nIf left untreated, they may develop into cervical cancer over time.",
    infographic: "/placeholder.svg?height=300&width=400&text=Transformation+Zone+Changes",
  },
  {
    id: 2,
    title: "The Role of HPV",
    content:
      "High-risk types of the human papillomavirus (HPV) are the main cause of cervical pre-cancer. These infections can stay in the body for a long time and gradually cause abnormal cell growth.\n\nPersistent HPV infection increases the risk of developing cervical pre-cancer.",
    infographic: "/placeholder.svg?height=300&width=400&text=HPV+Infection+Timeline",
  },
  {
    id: 3,
    title: "Why Early Detection Matters",
    content:
      "Unlike many other cancers, cervical cancer usually develops slowly, starting as a pre-cancer over many years. This long timeline allows for early detection through screening.\n\nDetecting and treating pre-cancer early can prevent it from turning into cancer.",
    infographic: "/placeholder.svg?height=300&width=400&text=Early+Detection+Saves+Lives",
  },
];
...
export default function Section2_2({ onComplete, isUnlocked }: Section1_2Props) {
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <CardTitle className="text-xl">Section 2: {sections[1].title}</CardTitle>
