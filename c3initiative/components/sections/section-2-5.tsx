...
const learningCards = [
  {
    id: 1,
    title: "How Cervical Cancer Develops",
    content:
      "Cervical cancer usually develops gradually, often over 10–20 years, as abnormal cells in the cervix progress to precancerous conditions like CIN (cervical intraepithelial neoplasia) and eventually to cancer.",
    infographic: "/placeholder.svg?height=300&width=400&text=Cancer+Development+Timeline",
  },
  {
    id: 2,
    title: "Faster Progression in Weakened Immunity",
    content:
      "In some cases, especially with weakened immune systems, this process can be faster, taking 5–10 years.",
    infographic: "/placeholder.svg?height=300&width=400&text=Faster+Progression+in+Immunocompromised",
  },
];
...
export default function Section2_5({ onComplete, isUnlocked }: Section1_2Props) {
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <CardTitle className="text-xl">Section 4: {sections[4].title} </CardTitle>
