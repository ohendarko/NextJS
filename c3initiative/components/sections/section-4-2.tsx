...
const learningCards = [
  {
    id: 1,
    title: "Licensed HPV Vaccines",
    content: "The two high-risk HPV types that cause cervical cancer are types 16 and 18, responsible for ~70% of cervical cancer cases.\n\nAs of June 2024, WHO recognizes three licensed HPV vaccines:\n1. Bivalent (Cervarix)\n2. Quadrivalent (Gardasil/Silgard)\n3. Nonavalent (Gardasil 9)",
    infographic: "/placeholder.svg?height=300&width=400&text=HPV+Vaccine+Types"
  },
  {
    id: 2,
    title: "How HPV Vaccines Work",
    content: "• HPV vaccines contain virus-like particles (no actual virus)\n• These particles trigger antibodies\n• Antibodies prevent HPV infection upon exposure\n\nVaccines should be given before HPV exposure\n– Ideally before onset of sexual activity",
    infographic: "/placeholder.svg?height=300&width=400&text=How+HPV+Vaccines+Work"
  },
  {
    id: 3,
    title: "Contraindications & Notes on HPV Vaccines",
    content: "Do NOT vaccinate:\n• Persons with severe allergic reactions to previous dose or components (e.g., yeast)\n• Girls with severe febrile illness\n• Pregnant women – postpone remaining doses until after pregnancy\n\nImportant:\n• Vaccines are preventive, not curative\n• Do not treat existing HPV infections\n• Can be administered with other non-live vaccines",
    infographic: "/placeholder.svg?height=300&width=400&text=HPV+Vaccine+Safety"
  }
];
...
export default function Section4_2({ onComplete, isUnlocked }: Section1_2Props) {
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <CardTitle className="text-xl">Section 2: HPV Vaccines</CardTitle>
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  Explore how HPV vaccines work, when to vaccinate, and special cases
                </p>
              </div>
            </div>
