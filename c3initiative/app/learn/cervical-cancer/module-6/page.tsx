...
import Section6_1 from "@/components/sections/section-6-1"
...
const sections = [
  {
    ...
    description: "Explore available treatments like surgery, radiation, chemotherapy, and palliative care",
...
export default function Module6Page() {
  ...
  const ActiveSectionComponent = sections.find((s) => s.id === activeSection)?.component || Section6_1
        ...
        <Card className="mb-8 hover-shadow-gradient">
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-3xl">Module 6: {modules[5].title} </CardTitle>
                <p className="text-gray-600 dark:text-gray-400 mt-2">
                  Understanding the management of cervical cancer
                </p>
              </div>
