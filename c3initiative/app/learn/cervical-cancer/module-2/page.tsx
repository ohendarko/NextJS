            ...
            <div className="mb-6">
              ...
              <div className="relative bg-gray-900 rounded-lg overflow-hidden aspect-video">
                <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50">
                  <Button size="lg" className="gradient-blue-pink text-white">
            ...
            <CardContent className="p-6">
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Congratulations! You've successfully completed the Cervical Cancer Overview module.
                </p>
                <div className="flex justify-center space-x-4">
                  <Link href="/learn/cervical-cancer">
                    <Button className="gradient-blue-pink text-white hover-shadow-gradient">
