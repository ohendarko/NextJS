      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-pharma-light-blue transition-colors">Privacy Policy</a></li>
              <li><a href="#" className="hover:text-pharma-light-blue transition-colors">Terms of Service</a></li>
              <li><a href="#" className="hover:text-pharma-light-blue transition-colors">Cookie Policy</a></li>
            </ul>
          </div>
        </div>
